...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/annonce/update">
            ...
            <div class="input-wrapper">
                <select id="categoryId" name="categoryId" required>
                    <c:forEach items="${categories}" var="cat">
                        <option value="${cat.id}" ${annonce.category.id == cat.id ? 'selected' : ''}>${cat.label}</option>
                    </c:forEach>
                </select>
        ...
        <div class="form-group">
            <label for="status">Statut de l'annonce</label>
            <div class="input-wrapper">
                <select id="status" name="status" required>
                    <c:forEach items="${statuses}" var="stat">
                        <option value="${stat}" ${annonce.status == stat ? 'selected' : ''}>${stat}</option>
                    </c:forEach>
                </select>
